...
public class DoubleAverageResampleCalculatorTest {

  private DoubleAverageResampleCalculator calculator;

  @Test
  public void testCalculateTransformedSample() throws Exception {
    this.calculator = new DoubleAverageResampleCalculator(0.5);
